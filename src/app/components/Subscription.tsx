...
import bgImageSubscription from '../assets/svgs/landingpage/subscriptionImage.svg';
            ...
            <div>
                <div className="font-inter flex flex-col lg:flex-row md:flex-col items-center space-y-6 md:space-y-6 md:space-x-5 justify-center">
                    ...
                    <div className="flex flex-col p-6 md:p-8 bg-white border-2 border-purple rounded-2xl w-full h-[340px] sm:h-[360px]">
                        ...
                        <div className="flex flex-col leading-7">
                            <div className="flex flex-row items-center">
                                <Image src={tick} className="w-4 sm:w-5" alt="tick" width={20} height={20} />
                                <p className="text-sm sm:text-md font-medium text-black-lightblack ml-2">Digital Menu Management</p>
                            </div>
                            <div className="flex flex-row items-center">
                                <Image src={tick} className="w-4 sm:w-5" alt="tick" width={20} height={20} />
                                <p className="text-sm sm:text-md font-medium text-black-lightblack ml-2">Allergen Management</p>
                            </div>
                            <div className="flex flex-row items-center">
                                <Image src={tick} className="w-4 sm:w-5" alt="tick" width={20} height={20} />
                                <p className="text-sm sm:text-md font-medium text-black-lightblack ml-2">QR Code Display for Menus</p>
                            </div>
                        </div>
                    ...
                    <div
                        ...
                        style={{
                            backgroundImage: bgImageSubscriptionUrl,
                        }}
                    >
                        ...
                        <div className="flex flex-col leading-7">
                            <div className="flex flex-row items-center">
                                <Image src={whitetick} className="w-4 sm:w-5" alt="whitetick" width={20} height={20} />
                                <p className="text-sm sm:text-md font-medium text-white ml-2">All Silver Package Features</p>
                            </div>
                            <div className="flex flex-row items-center">
                                <Image src={whitetick} className="w-4 sm:w-5" alt="whitetick" width={20} height={20} />
                                <p className="text-sm sm:text-md font-medium text-white ml-2">24/7 Customer Support</p>
                            </div>
                            <div className="flex flex-row items-center">
                                <Image src={whitetick} className="w-4 sm:w-5" alt="whitetick" width={20} height={20} />
                                <p className="text-sm sm:text-md font-medium text-white ml-2">Order Management (OMS)</p>
                            </div>
                            <div className="flex flex-row items-center">
                                <Image src={whitetick} className="w-4 sm:w-5" alt="whitetick" width={20} height={20} />
                                <p className="text-sm sm:text-md font-medium text-white ml-2">Real-Time Sales & Analytics</p>
                            </div>
                        </div>
                    ...
                    <div className="flex flex-col p-6 md:p-8 bg-white border-2 border-purple rounded-2xl w-full h-[340px] sm:h-[360px] mx-auto">
                        ...
                        <div className="flex flex-col leading-7">
                            <div className="flex flex-row items-center">
                                <Image src={tick} className="w-4 sm:w-5" alt="tick" width={20} height={20} />
                                <p className="text-sm sm:text-md font-medium text-black-lightblack ml-2">All Platinum Package Features</p>
                            </div>
                            <div className="flex flex-row items-center">
                                <Image src={tick} className="w-4 sm:w-5" alt="tick" width={20} height={20} />
                                <p className="text-sm sm:text-md font-medium text-black-lightblack ml-2">Advanced QR Code Ordering</p>
                            </div>
                            <div className="flex flex-row items-center">
                                <Image src={tick} className="w-4 sm:w-5" alt="tick" width={20} height={20} />
                                <p className="text-sm sm:text-md font-medium text-black-lightblack ml-2">Custom Branding for Menus</p>
                            </div>
                        </div>
                        <button className="text-secondary font-semibold py-2 px-4 rounded-md w-full h-12 sm:h-14 mt-4 text-sm sm:text-md border border-secondary">Proceed to Checkout</button>
                    </div>
