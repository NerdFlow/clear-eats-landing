  ...
  return (
    ...
    >
      <div className="text-center text-white">
        ...
        <button className="text-purple bg-white rounded-full w-[140px] sm:w-[130px] md:w-[140px] lg:w-[170px] h-[40px] sm:h-[50px] md:h-[55px] lg:h-[60px] mt-6 sm:mt-8 md:mt-10 lg:mt-12 font-bold hover:bg-purple-500 hover:text-white hover:bg-purple transition-colors duration-300">
          Try Now
        </button>
      </div>
    </div>
