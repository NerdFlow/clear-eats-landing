    ...
    return (
        ...
        >
            <div className="text-center text-white">
                <h1 className="font-bold text-2xl sm:text-3xl md:text-4xl lg:text-5xl " style={{lineHeight:'1.2'}}>
                ...
                <button className="text-purple bg-white rounded-full w-[140px] sm:w-[130px] md:w-[140px] lg:w-[170px] h-[40px] sm:h-[50px] md:h-[55px] lg:h-[60px] mt-6 sm:mt-8 md:mt-10 lg:mt-12 font-bold">
                    Try Now
                </button>
            </div>
        </div>
