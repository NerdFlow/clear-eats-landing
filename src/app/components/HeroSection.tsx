...
const HeroSection: FC = () => {
  return (
    <div
      className=" relative h-screen sm:h-[33rem] md:h-[43.75rem] lg:h-[45rem] xl:h-[50rem] 2xl:h-[69rem]  bg-no-repeat bg-cover  "
      id="HeroSection"
    ...
    >
      ...
      <div className="flex">
        ...
        <div className="relative container flex flex-col justify-center max-w-[95%] h-full text-center text-white  w-full py-12 sm:p-12 lg:p-5 xl:p-32 gap-4 sm:gap-0 xl:gap-6">
          <div className="relative sm:max-w-4xl md:max-w-[100%] lg:w-[90%] mx-auto text-center">
          ...
          <div className="relative w-full">
            <p className=" mt-[0.25rem]  mb-[0.75rem] px-0 sm:px-[1.5rem] md:px-[2rem] lg:px-[2.5rem] tracking-wide">
          ...
          <div className="flex justify-center mt-[0.5rem] container">
